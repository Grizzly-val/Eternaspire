...
public class ChallengersSword extends Weapon{
    ...
    public ChallengersSword() {
        super("Challenger's Sword", "A beginner's best friend. It has seen countless challenges, and survived every single one. Whether you do is up to you.", "cutscene_FirstTimeEquip_ChallengersSword",10);
    }
    ...
    public void basicAttack(Challenger user, Entity opponent, int atk) {
        ...
        if(user.getHp() <= user.getMaxHp() * 0.4){
            ...
            user.dmgAttack(opponent, (int)(atk * 2.5));
